...
.loop:				; print loop
	...
	jmp .loop		; if not, print the next coordinate
...
;;; Print rectangle
;; @param: push onto stack in that order:
;; Color -> Begin X coordinate -> Begin Y coordinate -> End X coordinate -> End Y coordinate
;; @reg: ax, bx, dx, cx
printRect:
	; pop al
	pop dx
